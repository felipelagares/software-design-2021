1. O id gerado para a chave id será um valor inteiro aleatório ou um conjuto de valores inteiros aleatórios gerados pela classe Random (Java) em uma faixa de valores estabelecida pelo usuário.
